"""
Training script for VSAEGated with all the robustness improvements.
...
class ExperimentConfig:
    """Configuration for the entire VSAEGated experiment."""
    # Model configuration
...
class ExperimentRunner:
    """Manages the entire VSAEGated training experiment."""
    ...
    def evaluate_model(self, save_dir: Path, buffer: TransformerLensActivationBuffer) -> Dict[str, float]:
        ...
        try:
            ...
            # Add VSAEGated-specific diagnostics
            try:
...
# python train_vsae_gated.py --config learned_variance
# python train_vsae_gated.py --config gpu_10gb
# python train_vsae_gated.py --config aggressive_annealing
