...
def main():
    ...
    if args.features == "active":
        ...
        feature_indices = [1274,1276,1284,1316,1321,1324,1341,1356,1383,1384,1386,1388,1413,1424,1427,1432,1435,1462,1468,1482,1483,1502,1549,1551,1564,1566,1575,1589] #vsae256
