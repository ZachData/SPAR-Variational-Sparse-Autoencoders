"""
Improved training script for VSAEGated with better practices and architecture.
"""
...
from dictionary_learning.trainers.vsae_gated import (
    VSAEGated,
    VSAEGatedTrainer,
    GatedVSAEConfig,
    GatedTrainingConfig
...
class ExperimentRunner:
    ...
    def create_training_config(self) -> GatedTrainingConfig:
        """Create training configuration from experiment config."""
        return GatedTrainingConfig(
    ...
    def create_trainer_config(
        ...
        return {
            ...
            "training_config": training_config,  # Pass actual objects to trainer
    ...
    def get_experiment_name(self) -> str:
        ...
        return (
            ...
            f"l1{self.config.l1_penalty}_aux{self.config.aux_weight}_"
...
def create_full_config() -> ExperimentConfig:
    ...
    return ExperimentConfig(
        ...
        # WandB settings
        use_wandb=True,
        wandb_entity="zachdata",
        wandb_project="vsae-experiments",
    )
...
def main():
    ...
    if results:
        key_metrics = ["frac_variance_explained", "l0", "frac_alive", "frac_recovered"]
