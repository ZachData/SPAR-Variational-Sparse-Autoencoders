...
def trainSAE(
    ...
    # Ensure all trainers are using the same dtype as our autocast context
    for trainer in trainers:
        # Convert model parameters to the correct dtype
        trainer.ae = trainer.ae.to(device=device, dtype=autocast_dtype)
    ...
    for step, act in enumerate(tqdm(data, total=steps)):
        # Convert input data to the same precision as model
